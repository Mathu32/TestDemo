...
public interface TempConvertSoap {
    ...
    @RequestWrapper(localName = "FahrenheitToCelsius", targetNamespace = "https://www.w3schools.com/xml/", className = "com.example.soapclient.tempconvert.FahrenheitToCelsius")
    @ResponseWrapper(localName = "FahrenheitToCelsiusResponse", targetNamespace = "https://www.w3schools.com/xml/", className = "com.example.soapclient.tempconvert.FahrenheitToCelsiusResponse")
    ...
    @RequestWrapper(localName = "CelsiusToFahrenheit", targetNamespace = "https://www.w3schools.com/xml/", className = "com.example.soapclient.tempconvert.CelsiusToFahrenheit")
    @ResponseWrapper(localName = "CelsiusToFahrenheitResponse", targetNamespace = "https://www.w3schools.com/xml/", className = "com.example.soapclient.tempconvert.CelsiusToFahrenheitResponse")
